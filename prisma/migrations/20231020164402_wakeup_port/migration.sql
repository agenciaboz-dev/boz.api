/*
  ...
  - Added the required column `port` to the `ApiTester` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `ApiTester` ADD COLUMN `port` VARCHAR(191) NOT NULL;
